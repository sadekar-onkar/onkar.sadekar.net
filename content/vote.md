---
# The phone screen attendees reach by scanning the QR code.
# Live-only: it is noindex, it is not in the nav, and it holds no data.
# All the wording on it is here.

page_title: Workshop voting
description: Live interest voting for workshop attendees.

join_title: Enter the room code
join_lede: The code is on the screen at the front of the room.
